...
<html>
  ...
  <head>
    <title> Contact | ARPIT Cafe </title>
  </head>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top navigation-clean-search" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">ARPIT Cafe</a>
        </div>
...
?>
    ...
    <div class="heading">
     <strong>Want to contact <span class="edit"> ARPIT Cafe </span>?</strong>
     <br>
    ...
    <div class="col-md-5" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <br style="clear: both">
          ...
          <div class="form-group">
            <input type="tel" class="form-control"maxlength="10" minlength="10" id="mobile" name="mobile" placeholder="Mobile Number" required>
          </div>
